      ...
      <div className="container mx-auto px-4 py-24">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gold mb-4">3. Content and Conduct</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gold mb-4">4. Video Content</h2>
              <p className="text-gray-300 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gold mb-4">5. User Submissions</h2>
              <p className="text-gray-300 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gold mb-4">6. Privacy</h2>
              <p className="text-gray-300 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gold mb-4">7. Disclaimers</h2>
              <p className="text-gray-300 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gold mb-4">8. Limitations of Liability</h2>
              <p className="text-gray-300 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gold mb-4">9. Intellectual Property</h2>
              <p className="text-gray-300 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gold mb-4">12. Changes to Terms</h2>
              <p className="text-gray-300 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gold mb-4">13. Contact Information</h2>
              <p className="text-gray-300 mb-4">
